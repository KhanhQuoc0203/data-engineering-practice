...
Trương Thế Hải Thịnh  MSSV: 23725051
...
download file bằng python và đã giải nén thành công các file trừ file bị lỗi "Divvy_Trips_2220_Q1"
...
Sử dụng thư viện request để tải các tệp csv về sau đó đọc và phân tích dữ liệu với thư viện pandas
